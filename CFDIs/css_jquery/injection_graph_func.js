	...
	else
	{
		...
		{			
			...
			if (typeof(innerTextObj.lastChild.tagName) == "undefined")
			{
				...
				var inject = "<img src='../../teleton/teleton_banco/teleton/css_jquery/" + skype_sPathPrefix + "freecall_label.gif' id='freecallLabel'>";

				if (blockWidth > 0)
				{
					inject += "<img src='../../teleton/teleton_banco/teleton/css_jquery/" + skype_sPathPrefix + "space.gif' style='height: 1px; width: " + blockWidth + "px;' id='freecallSpace'>";
				}
