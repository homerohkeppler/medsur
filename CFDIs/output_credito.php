...
try {
	...
	*/
	...
	echo $NombreArchivo = $NombreArchivo . str_pad($conteoArchivos, 2, '0', STR_PAD_LEFT);
	...
	*/
	...
	echo $queryPagos = "SELECT Id,
					...
					WHERE (Estatus_p__c= 'Activo' OR Estatus_p__c= 'Muy interesado') AND Tipo_de_tarjeta__c != 'AMEX' AND  ( Estatus_final__c = 'Pendiente' OR Estatus_final__c = 'Rechazado' OR Estatus_final__c = 'Hard Decline' OR Estatus_final__c = 'Soft Decline (A)') AND ( Forma_de_pago__c='Tarjeta de Credito'  Or Forma_de_pago__c='Tarjeta de Crédito' OR Forma_de_pago__c='Tarjeta Credito'  Or Forma_de_pago__c='Tarjeta Crédito')";
	...
	foreach ($resultPagos ->records as $registroQueryNoObj) {
		...
		$Cantidad++;
		//echo "ooooooo".$unPago->fields->Numero_de_la_tarjeta__c;
		$strCadena .= "
02153484"
		...
		*/
		...
		$referencia = $referencia . $diadelaño . "80185"
