...
try {
	...
	*/
	...
	echo $queryPagos = "SELECT Id,
					...
					WHERE Tipo_de_tarjeta__c != 'AMEX' AND  ( Estatus_final__c = 'Pendiente' OR Estatus_final__c = 'Rechazado' OR Estatus_final__c = 'Hard Decline' OR Estatus_final__c = 'Soft Decline (A)') ) AND ( Forma_de_pago__c='Tarjeta de Credito'  Or Forma_de_pago__c='Tarjeta de Crédito' OR Forma_de_pago__c='Tarjeta Credito'  Or Forma_de_pago__c='Tarjeta Crédito') AND (Padrino__r.Name  ='13159' OR Padrino__r.Name  ='13128' OR Padrino__r.Name  ='13108' )";
